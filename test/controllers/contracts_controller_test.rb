...
class ContractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract" do
    assert_difference('Contract.count') do
      post contracts_url, params: { contract: { name: @contract.name, type: @contract.type } }
    end
  ...
  test "should update contract" do
    patch contract_url(@contract), params: { contract: { name: @contract.name, type: @contract.type } }
